...
# 📂 रेंडर क्लाउडसाठी पाथ फिक्स (फोल्डर कुठेही असले तरी शोधून काढेल)
...
# Jinja2 टेम्पलेट इंजिन सेट करणे
...
async def start_copy_engine(engine_id: int):
    ...
    try:
        ...
        API_TOKEN = "YOUR_METAAPI_TOKEN_HERE"  # तुमचा MetaAPI टोकन इथे टाका
